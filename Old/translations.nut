...
SetScriptVersion("Translations", "1.0.5")
::TRANSLATION_TABLE <- {
	english = {
		...
		IH_OOB_ARG              = IH_color_header + "[Item Helper]" + IH_error_color + " {Error}\x01 Out Of Bounds Value Set! : %s" // has to be %s
		...
		PRETTYBOYS_DESC 		= " Fires a slow-moving rocket that deals massive damage in large area. Very slow reload and low ammo."
		//
		...
		COWMANGLER_DESC			= " Chance to stun enemies on hit. Charged shot causes resulting burn and bleed damage to stack and crit."
		//
		...
		RESERVESHOOTER_DESC 	= " Deals a flat 10,000 damage per shot no matter the range with bullet penetration and 3s mini-crits on kill. However this weapon cannot be crit boosted, and cannot damage Tanks." 
		//
		...
		MARKETGARDENER_DESC 	= " High risk/High reward - Successful hit deals massive damage, but if you miss it kills you instead."
		//
		...
		RAINBLOWER_DESC			= " Long-range flamethrower dealing low direct damage, but high afterburn damage. Also able to instantly destroy Engineer buildings. Airblast is weak, but very fast."
		//
		...
		MANMELTER_DESC 			= " Rapid-fire flares specialized to automatically seek out enemies. Unlimited ammo and no reload." 
		//
		SCORCHSHOT_NAME 		= "SCORCH SHOT" 
		SCORCHSHOT_DESC 		= " Flares automatically seek enemies. On hit: Deal large damage, extinguish the enemy and inflict a strong push force. Your target MUST be on fire, or this attack will do nothing." 
		//
		...
		VOLCANOFRAGMENT_DESC 	= " Chance to stun enemies on hit."
		//
		POSTALPUMMELER_NAME 	= "POSTAL PUMMELER"
		POSTALPUMMELER_DESC 	= " Able to send a small enemy back to spawn with 1 health, removing all of their items and buffs. On miss: Send yourself back to spawn instead."
		//
		MAUL_NAME 				= "MAUL"
		MAUL_DESC 				= " Launch enemies into the sky on hit, but launch yourself on miss."
		//
		...
		IRONBOMBER_DESC			= " Ignores enemy resistances and gains a short critboost on kill. Does not require ammo and has an endless clip. Projectiles can bounce off of walls and deal 2x damage."
		///
		...
		SKULLCUTTER_DESC 		= " Deal x10 damage to enemies of the same class as you. Gain crits and mini-crits on kill."
		//
		...
		SCOTTISHHANDSHAKE_DESC 	= "While active: Resist 99% ranged damage, become immune to knockback and greatly increase max health. However you cannot recover ammo and receive less health from packs."
		//----------------------------
		//----------------------------
		//----------------------------
		...
		KILLINGGLOVES_DESC 		= " Special Ability: 'Mega-Crush' -  When available, press your action slot key to gain increased move speed, defense and crits for 12s, OR, use while standing on the bomb to instantly send it back to start.."
		//
		GLOVESRUNNING_NAME 		= "GLOVES OF RUNNING URGENTLY"
		GLOVESRUNNING_DESC 		= " While active, able to leap high into the air and deploy a parachute. This parachute remains active when you switch back to your minigun."
		//
		...
		POMSON_DESC 			= " Inflict bleed and slow enemies down with full auto-aim."
		//
		...
		GUNSLINGER_DESC	 		= " Able to build a secondary Sentry."
		//
		...
		OVERDOSE_DESC 			= " Requires and consumes 100% Ubercharge to send a homing payload that shuts down all nearby small enemies for up to 15s."
		///
		...
		AMPUTATOR_DESC			= " Hit your teammates to transfer your health to them and heal them instantly. Gain 5% Uber on hit."
		//
		...
		///
		SMG_NAME 				= "SMG"
		SMG_DESC 				= " Able to headshot for greatly increased damage."
		//
		...
		///
		KNIFE_NAME 				= "KNIFE"
		KNIFE_DESC 				= " While active, the Knife drains your health but grants immunity to ALL damage. Kills restore health. 93,750 Giant backstab damage."
		//
		...
		KUNAI_DESC 				= " Infinite melee range. 46,875 Giant backstab damage."
		//
		...
		SHARPDRESSER_DESC 		= " Backstabs trigger an explosion, dealing extra damage to nearby targets. 4,688 Giant backstab damage."
		//
		SPYCICLE_NAME 			= "SPY-CICLE"
		SPYCICLE_DESC 			= " 'Missed' swing causes you to leap into the air for free surf-stabs, but you cannot disguise. 262,500 Giant backstab damage."
		///
		INVISWATCH_NAME 		= "INVIS WATCH"
		INVISWATCH_DESC 		= " Infinite cloak, +10% faster move speed."
		//
		DEADRINGER_NAME 		= "DEAD RINGER"
		DEADRINGER_DESC 		= " Immune to fall damage, 20% damage resistance, +100% cloak regen rate."
		//
...
{
	// local msg = "[\"" + language + "\" has %i entrys]"
	// local count = 0
	// foreach (translation in table)
		// count++
